...
module.exports = {
    ...
    writing: (generator, languageServerConfig) => {
        ...
        generator.fs.copyTpl(generator.templatePath('tsconfig.base.json'), generator.destinationPath('tsconfig.base.json'), languageServerConfig);
        ...
        generator.fs.copyTpl(generator.templatePath('client/package.json'), generator.destinationPath('client/package.json'), languageServerConfig);
        ...
        generator.fs.copyTpl(generator.templatePath('server/tsconfig.json'), generator.destinationPath('server/tsconfig.json'), languageServerConfig);
        generator.fs.copyTpl(generator.templatePath('server/.eslintrc.json'), generator.destinationPath('server/.eslintrc.json'));
        generator.fs.copyTpl(generator.templatePath('server/.eslintignore'), generator.destinationPath('server/.eslintignore'));
        generator.fs.copyTpl(generator.templatePath('server/webpack.config.js'), generator.destinationPath('server/webpack.config.js'));
        generator.fs.copyTpl(generator.templatePath('server/bin/sample-server'), generator.destinationPath(`server/bin/${languageServerConfig.serverName}`));
